...
# 性能测试sheet页面
SHEET_TEST_ENVIRONMENT = u'测试环境'
SHEET_CPU = u'CPU 性能'
SHEET_MEMORY = u'内存性能'
SHEET_TX = u'上行速率'
SHEET_RX = u'下行速率'
SHEET_BATTERY_TEMPERATURE = u'电池温度'
SHEET_FPS = u'FPS 性能'
SHEET_COLD_BOOT = u'冷启动性能'
SHEET_WARM_BOOT = u'热启动性能'

# 性能测试sheet页面List
PERFORMANCE_REPORT_SHEET = [
    SHEET_TEST_ENVIRONMENT,
    SHEET_CPU,
    SHEET_MEMORY,
    SHEET_TX,
    SHEET_RX,
    SHEET_BATTERY_TEMPERATURE,
    SHEET_FPS,
    SHEET_COLD_BOOT,
    SHEET_WARM_BOOT
]
