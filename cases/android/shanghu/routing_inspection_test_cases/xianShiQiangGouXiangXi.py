...
class XianShiQiangGouXiangXiTestCase(TestCase):
    '''
    巡检 No.16
    用例名 限时抢购详细
    限时抢购详细检查
    ...
    def testXianShiQiangGouXiangXi(self):
        ...
        # tempSave = shangPinGuanLiPage.getToBeExaminedDetails()
        # shangPinGuanLiPage.validToBeExaminedDetails(tempSave)
        ...
        # shangPinGuanLiPage.validToBeExaminedDetails(toBeExamined)
        shangPinGuanLiPage.clickBackKey()
        shangPinGuanLiPage.validPassed()
        # passed = shangPinGuanLiPage.getToBeExaminedDetails()
        # shangPinGuanLiPage.validToBeExaminedDetails(passed)
        shangPinGuanLiPage.clickBackKey()
        shangPinGuanLiPage.validReject()
        # reject = shangPinGuanLiPage.getToBeExaminedDetails()
        # shangPinGuanLiPage.validToBeExaminedDetails(reject)


if __name__ == "__main__":
    suite = TestLoader().loadTestsFromTestCase(XianShiQiangGouXiangXiTestCase)
