...
class GouWuZhongXinTestCase(TestCase):
    ...
    def testGouWuZhongXin(self):
        ...
        for i in range(1):
            ...
            dashboardPage.screenShotForStability("aiGuangJie", self.loopNumer, str(i+1), "1")
            ...
            for tabNumber in tabNumberList:
                ...
                shoppingMallPage.screenShotForStability("gouWuZhongXinXiangXi", self.loopNumer, str(i+1), str(tabNumber+2))
