...
if __name__ == "__main__":
    ...
    suite.addTest(QuanChengSouSuoPinPaiTestCase("testQuanChengSouSuoPinPai")) # 全城搜索品牌 No.3-1
    suite.addTest(QuanChengSouSuoShangPinTestCase("testQuanChengSouSuoShangPin")) # 全城搜索商品 No.3-2
    suite.addTest(QuanChengSouSuoMenDianTestCase("testQuanChengSouSuoMenDian")) # 全城搜索品牌 No.3-3
    ...
    suite.addTest(GuangChangHuiYuanTestCase("testGuangChangHuiYuan")) # 广场会员 No.31
    ...
    suite.addTest(FeiFanTongZhangDanTestCase("testFeiFanTongZhangDan")) # 飞凡通账单 No.45
    #suite.addTest(FeiFanTongQiTaKuaiJieRuKouTestCase("testFeiFanTongQiTaKuaiJieRuKou")) # 飞凡通其他快捷入口 No.46
    ...
    #suite.addTest(WoDeSheZhiXiuGaiDengLuMiMaTestCase("testWoDeSheZhiXiuGaiDengLuMiMa")) # 我的设置(修改登录密码) No.59-1
