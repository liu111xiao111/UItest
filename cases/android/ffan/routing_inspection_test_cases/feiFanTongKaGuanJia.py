...
from pages.android.ffan.feifan_card_manager_page import FeiFanCardManagerPage
from pages.android.ffan.feifan_card_page import FeiFanCardPage
from utility.logger import Logger
from utility.device_info_util import DeviceInfoUtil


class FeiFanTongKaGuanJiaTestCase(TestCase):
    '''
    作者 乔佳溪
    巡检checklist No.: 43
    自动化测试case No.: 43
    ...
    def testFeiFanTongKaGuanJia(self):
...
if __name__ == "__main__":
    suite = TestLoader().loadTestsFromTestCase(FeiFanTongKaGuanJiaTestCase)
