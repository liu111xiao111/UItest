...
from com.qa.automation.appium.pages.android.ffan.feifan_card_charge_page import FeiFanCardChargePage
...
class FeiFanCardChargeCases(TestCase):
    '''
    巡检checklist No.: 44
    自动化测试case No.: 44
...
if __name__ == "__main__":
    suite = TestLoader().loadTestsFromTestCase(FeiFanCardChargeCases)
