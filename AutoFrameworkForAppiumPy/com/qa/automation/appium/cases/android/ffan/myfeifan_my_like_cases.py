...
from com.qa.automation.appium.pages.android.ffan.my_ffan_my_like_page import *;
...
class MyfeifanMyOrderCases(unittest.TestCase):
    ...
    def test_case(self):
        ...
        myLikePage = MyFfanMyLikePage(testcase=self, driver=self.driver, logger=self.logger)
