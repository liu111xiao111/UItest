...
from com.qa.automation.appium.pages.ios.ffan.personal_information_page import PersonalInformationPage
...
if __name__ == "__main__":
    suite = TestLoader().loadTestsFromTestCase(PersonalInformationCases)
