...
class GoodsDetailsPage(SuperPage):
    ...
    def validSelf(self):
        ...
        API().assert_view_by_resourceID_Until_android(self.testcase, self.driver, self.logger, GoodsDetailsPageConfigs.resource_id_reource_goods_details_title, GoodsDetailsPageConfigs.assert_view_timeout)
