...
class MessageCentrePage(SuperPage):
    ...
    def validSelf(self):
        ...
        API().assert_view_by_resourceID_Until_android(self.testcase, self.driver, self.logger, MessageCentrePageConfigs.resource_id_message_centre_title, MessageCentrePageConfigs.assert_view_timeout)
