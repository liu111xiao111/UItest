...
class SquareShoppingPage(SuperPage):
    ...
    '''
    def validSelf(self):
        API().assert_view_by_resourceID_Until_android(testcase = self.testcase, driver = self.driver, logger = self.logger, resource_id = SquareShoppingPageConfigs.resource_id_iv_find_iv, seconds = 10);
