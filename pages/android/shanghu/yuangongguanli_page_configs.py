...
class YuanGongGuanLiPageConfigs():
    ...
    resource_id_phone = "com.feifan.bp:id/tv_staff_telephone"
    resource_id_creator = "com.feifan.bp:id/tv_staff_creator"
    resource_id_create_time = "com.feifan.bp:id/tv_staff_create_time"
